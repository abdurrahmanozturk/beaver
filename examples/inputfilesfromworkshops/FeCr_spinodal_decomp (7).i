...
[BCs]
  ...
  [../]
[]
# Kernels for solving the Cahn-Hilliard eqn to simulate spinodal decomposition in Fe-Cr alloy
[Kernels]
  [./w_dot]
    variable = w
    v = c
...
[Materials]
  ...
  [./constants]
    # Define constant values kappa_c and M (mobility). Eventually M will be replaced with
  ...
  [./Free_Energy]
    ...
    derivative_order = 2
  [../]
  [./precipitate_indicator]  # Returns 1/625 if inside the precipitate
    type = ParsedMaterial
    f_name = prec_indic
    args = c
...
[Postprocessors]
  ...
  [../]
  [./num_precipitates]          # Number of precipitates formed
    type = FeatureFloodCount
    variable = c
    threshold = 0.8
  [../]
  [./precipitate_area]      # Area Fraction of precipitates
