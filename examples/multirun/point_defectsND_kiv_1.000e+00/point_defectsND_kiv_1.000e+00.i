...
[Materials]
 ...
 [./Kiv]
   ...
   f_name = Kiv
   args = xv
   function = 'kiv:=1.000e+00;-kiv*xv'  # 1/s regular case, parametric study
 [../]
 [./Kvi]
   type = DerivativeParsedMaterial
   f_name = Kvi
   args = xi
   function = 'kiv:=1.000e+00;-kiv*xi'  # 1/s regular case, parametric study
 [../]
 [./Kis]
   type = DerivativeParsedMaterial
   f_name = Kis
...
[Outputs]
  # exodus = true
  file_base = point_defectsND_kiv_1.000e+00/point_defectsND_kiv_1.000e+00
  [./exodus]
    type = Exodus
