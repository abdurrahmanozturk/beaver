...
[Kernels]
  [./defect_generation_i]
    ...
    variable = xi
    value = 1e-1   #dpa/s regular case, 1e-7 : recdom,i parametric study
  [../]
  [./defect_generation_v]
    type = BodyForce
    variable = xv
    value = 1e-1   #dpa/s regular case, 1e-7 : recdom,v  parametric study
  [../]
  [./recombination_i]
    type = MatReaction
    variable = xi
...
[Materials]
 ...
 [./Kiv]
   ...
   f_name = Kiv
   args = xv
   function = 'kiv:=1.000e+03;-kiv*xv'  # 1/s regular case, parametric study
 [../]
 [./Kvi]
   type = DerivativeParsedMaterial
   f_name = Kvi
   args = xi
   function = 'kiv:=1.000e+03;-kiv*xi'  # 1/s regular case, parametric study
 [../]
 [./Kis]
   type = DerivativeParsedMaterial
   f_name = Kis
...
[Outputs]
  # exodus = true
  file_base = point_defectsND_kiv_1.000e+03/point_defectsND_kiv_1.000e+03
  [./exodus]
    type = Exodus
