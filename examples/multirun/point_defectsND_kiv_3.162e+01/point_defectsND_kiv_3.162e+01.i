...
[Materials]
 ...
 [./Kiv]
   ...
   f_name = Kiv
   args = xv
   function = 'kiv:=3.162e+01;-kiv*xv'  # 1/s regular case, parametric study
 [../]
 [./Kvi]
   type = DerivativeParsedMaterial
   f_name = Kvi
   args = xi
   function = 'kiv:=3.162e+01;-kiv*xi'  # 1/s regular case, parametric study
 [../]
 [./Kis]
   type = DerivativeParsedMaterial
   f_name = Kis
...
[Outputs]
  # exodus = true
  file_base = point_defectsND_kiv_3.162e+01/point_defectsND_kiv_3.162e+01
  [./exodus]
    type = Exodus
