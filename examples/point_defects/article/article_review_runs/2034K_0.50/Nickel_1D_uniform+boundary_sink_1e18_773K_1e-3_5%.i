...
[AuxVariables]
  ...
  [./Dv]    #Vacancy  Diffusion Coefficient {m^2/s}
    initial_condition = 2.00
  [../]
  [./K0]     #Displacement damage rate  {dpa/s}
    initial_condition = 5.535234141775167e-16
  [../]
  ...
  [./Kiv]     #Recombination rate  {1/s}
    initial_condition = 110.03410592468965
  [../]
  [./Kis]     #Sink Reaction rate  {1/s}
    initial_condition = 36.677963982209185
  [../]
  [./Kvs]     #Sink Reaction rate  {1/s}
    initial_condition = 31.259719577761572
  [../]
  [./xie]
  [../]
  [./xve]
    initial_condition = 0.00010879477024677965
  [../]
  [./super_saturation]
  [../]
...
[ICs]
  [./xv]
    type = RandomIC
    min = 1.0e-4       # Nickel equilibrium vacancy concentration
    max = 1.1e-4
    variable = xv
  [../]
  [./xi]
...
[Outputs]
  # exodus = true
  file_base = Nickel_1D_uniform+boundary_sink_1e18_2034K_1e-3_5%
  [./exodus]
    type = Exodus
