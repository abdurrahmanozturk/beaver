...
[AuxVariables]
  ...
  [./Dv]    #Vacancy  Diffusion Coefficient {m^2/s}
    initial_condition = 4.00
  [../]
  [./K0]     #Displacement damage rate  {dpa/s}
    initial_condition = 4.496002301944627e-16
  [../]
  ...
  [./Kiv]     #Recombination rate  {1/s}
    initial_condition = 183.39078021138846
  [../]
  [./Kis]     #Sink Reaction rate  {1/s}
    initial_condition = 36.67796398220919
  [../]
  [./Kvs]     #Sink Reaction rate  {1/s}
    initial_condition = 62.51966600675254
  [../]
  [./xie]
  [../]
  [./xve]
    initial_condition = 0.0003298059859333839
  [../]
  [./super_saturation]
  [../]
...
[ICs]
  [./xv]
    type = RandomIC
    min = 3.25e-4       # Nickel equilibrium vacancy concentration
    max = 3.35e-4
    variable = xv
  [../]
  [./xi]
...
[Outputs]
  # exodus = true
  file_base = Nickel_1D_uniform+boundary_sink_1e18_2316K_1e-3_5%
  [./exodus]
    type = Exodus
