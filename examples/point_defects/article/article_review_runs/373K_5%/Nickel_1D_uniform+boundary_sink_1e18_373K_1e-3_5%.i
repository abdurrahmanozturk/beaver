...
[AuxVariables]
  ...
  [./Dv]    #Vacancy  Diffusion Coefficient {m^2/s}
    initial_condition = 1.8456911467249526e-11
  [../]
  [./K0]     #Displacement damage rate  {dpa/s}
    initial_condition = 1.131351785010233e-12
  [../]
  [./K0_dist] #distributed displacement damage rate  {dpa/s}
    initial_condition = 1.131351785010233e-12
  [../]
  [./bias]    #vacancy generation rate bias {1 = no bias}
    initial_condition = 1.05e+00
  [../]
  [./Kiv]     #Recombination rate  {1/s}
    initial_condition = 36.677963982886155
  [../]
  [./Kis]     #Sink Reaction rate  {1/s}
    initial_condition = 36.677963982209185
  [../]
  [./Kvs]     #Sink Reaction rate  {1/s}
    initial_condition = 2.88478096882927e-10
  [../]
  [./xie]
  [../]
  [./xve]
    initial_condition = 2.4033246774687587e-22
  [../]
  [./super_saturation]
  [../]
...
[Functions]
  [./dist_source]
    type = ParsedFunction
    value = 'k0:=1.131351785010233e-12;mu:=5000;sigma:=1000;k0*exp(-((x-mu)^2)/(2*sigma^2))/(1.6e-3*sigma*(2*acos(-1))^0.5)'
  [../]
[]
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#--------------------------------------------------Kernels-----------------------------------------------
...
[ICs]
  [./xv]
    type = RandomIC
    min = 2.35e-22       # Nickel equilibrium vacancy concentration
    max = 2.45e-22
    variable = xv
  [../]
  [./xi]
...
[VectorPostprocessors]
  [./x_direc]
   type =  LineValueSampler
    start_point = '0 0 0'
    end_point = '10000 0 0'
    variable = 'xi xv jvx jix xie xve Di Dv K0_dist super_saturation void_nucleation_rate'
    num_points = 10001
    sort_by =  id
  [../]
[]
...
[Outputs]
  # exodus = true
  file_base = Nickel_1D_uniform+boundary_sink_1e18_373K_1e-3_5%
  [./exodus]
    type = Exodus
