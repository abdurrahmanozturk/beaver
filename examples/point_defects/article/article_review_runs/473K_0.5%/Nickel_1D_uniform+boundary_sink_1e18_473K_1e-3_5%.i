...
[AuxVariables]
  ...
  [./Dv]    #Vacancy  Diffusion Coefficient {m^2/s}
    initial_condition = 1.3268352593384095e-08
  [../]
  [./K0]     #Displacement damage rate  {dpa/s}
    initial_condition = 1.5725348319505922e-13
  [../]
  [./K0_dist] #distributed displacement damage rate  {dpa/s}
    initial_condition = 1.5725348319505922e-13
  [../]
  [./bias]    #vacancy generation rate bias {1 = no bias}
    initial_condition = 1.005e+00
  [../]
  [./Kiv]     #Recombination rate  {1/s}
    initial_condition = 36.677964468865355
  [../]
  [./Kis]     #Sink Reaction rate  {1/s}
    initial_condition = 36.67796398220919
  [../]
  [./Kvs]     #Sink Reaction rate  {1/s}
    initial_condition = 2.073818857344008e-07
  [../]
  [./xie]
  [../]
  [./xve]
    initial_condition = 8.942628835564223e-18
  [../]
  [./super_saturation]
  [../]
...
[Functions]
  [./dist_source]
    type = ParsedFunction
    value = 'k0:=1.5725348319505922e-13;mu:=5000;sigma:=1000;k0*exp(-((x-mu)^2)/(2*sigma^2))/(1.6e-3*sigma*(2*acos(-1))^0.5)'
  [../]
[]
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#--------------------------------------------------Kernels-----------------------------------------------
...
[ICs]
  [./xv]
    type = RandomIC
    min = 8.9e-18       # Nickel equilibrium vacancy concentration
    max = 9.0e-18
    variable = xv
  [../]
  [./xi]
...
[Outputs]
  # exodus = true
  file_base = Nickel_1D_uniform+boundary_sink_1e18_473K_1e-3_5%
  [./exodus]
    type = Exodus
