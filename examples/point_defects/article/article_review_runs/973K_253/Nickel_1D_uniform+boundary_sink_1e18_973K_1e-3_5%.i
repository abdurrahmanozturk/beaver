...
[AuxVariables]
  ...
  [./Dv]    #Vacancy  Diffusion Coefficient {m^2/s}
    initial_condition = 0.003965726717555685
  [../]
  [./K0]     #Displacement damage rate  {dpa/s}
    initial_condition = 3.5805400852752095e-15
  [../]
  ...
  [./Kiv]     #Recombination rate  {1/s}
    initial_condition = 36.82341876391899
  [../]
  ...
  [../]
  [./xve]
    initial_condition = 5.155543463663172e-09
  [../]
  [./super_saturation]
  [../]
...
[Functions]
  [./dist_source]
    type = ParsedFunction
    value = 'k0:=3.5805400852752095e-15;mu:=5000;sigma:=1000;k0*exp(-((x-mu)^2)/(2*sigma^2))/(1.6e-3*sigma*(2*acos(-1))^0.5)'
  [../]
[]
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#--------------------------------------------------Kernels-----------------------------------------------
...
[ICs]
  [./xv]
    type = RandomIC
    min = 4.7e-09       # Nickel equilibrium vacancy concentration
    max = 5.7e-09
    variable = xv
  [../]
  [./xi]
...
[Outputs]
  # exodus = true
  file_base = Nickel_1D_uniform+boundary_sink_1e18_973K_1e-3_5%
  [./exodus]
    type = Exodus
