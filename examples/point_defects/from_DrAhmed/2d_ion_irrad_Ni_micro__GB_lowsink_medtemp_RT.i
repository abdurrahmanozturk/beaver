...
[Materials]
  ...
  [./const]
    ...
    prop_values = '2.0e-4 1.0 -4.42e-2 -8.84e-6'
...
[]
[Outputs]
  file_base = ion_irr_2dRT_lowSink_IntermediateTemp_diffusion_to_GB256x32_1e-7l
  exodus = true
  csv = true
  interval = 1
