...
[Functions]
  [./dist_source]
    type = ParsedFunction
    value = 'k0:=9.037e-18;mu:=1250;sigma:=250;k0*exp(-((x-mu)^2)/(2*sigma^2))/(1.6e-3*sigma*(2*acos(-1))^0.5)'
  [../]
[]
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#--------------------------------------------------Kernels-----------------------------------------------
...
[Outputs]
  # exodus = true
  file_base = Nickel_1D_uniform+boundary_sink_1e18_773K_1e-6_0%_initial_condition_1.400e+00/Nickel_1D_uniform+boundary_sink_1e18_773K_1e-6_0%_initial_condition_1.400e+00
  [./exodus]
    type = Exodus
