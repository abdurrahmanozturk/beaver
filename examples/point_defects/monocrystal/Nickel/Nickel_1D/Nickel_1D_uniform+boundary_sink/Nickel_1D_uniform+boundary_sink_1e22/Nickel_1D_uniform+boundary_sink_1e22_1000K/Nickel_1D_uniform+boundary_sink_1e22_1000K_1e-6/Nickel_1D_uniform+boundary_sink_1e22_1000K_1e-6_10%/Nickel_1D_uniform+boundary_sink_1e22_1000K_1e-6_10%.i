...
[AuxVariables]
  ...
  initial_condition = 36.87868
  [../]
  [./Kis]     #Sink Reaction rate  {1/s}
  initial_condition = 36.67796
  [../]
  [./Kvs]     #Sink Reaction rate  {1/s}
  initial_condition = 0.2007166
  [../]
  [./ci]
  [../]
  [./cv]
...
[ICs]
  [./xv]
    type = RandomIC
    min = 8.63064e-9       # Nickel equilibrium vacancy concentration
    max = 8.73064e-9
    variable = xv
  [../]
  [./xi]
...
[Outputs]
  # exodus = true
  file_base = Nickel_1D_uniform+boundary_sink_1e22_1000K_1e-6_10%
  [./exodus]
    type = Exodus
