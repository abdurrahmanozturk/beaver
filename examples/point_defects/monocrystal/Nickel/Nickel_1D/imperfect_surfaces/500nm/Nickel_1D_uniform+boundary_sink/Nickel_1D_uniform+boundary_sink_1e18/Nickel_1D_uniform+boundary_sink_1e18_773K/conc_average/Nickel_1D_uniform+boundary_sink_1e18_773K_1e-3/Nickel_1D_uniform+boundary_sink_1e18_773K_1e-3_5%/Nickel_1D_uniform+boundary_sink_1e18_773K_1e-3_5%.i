...
[Functions]
  [./dist_source]
    type = ParsedFunction
    value = 'k0:=9.037e-15;mu:=2500;sigma:=500;k0*exp(-((x-mu)^2)/(2*sigma^2))/(1.6e-3*sigma*(2*acos(-1))^0.5)'
  [../]
[]
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#--------------------------------------------------Kernels-----------------------------------------------
...
[BCs]
  ...
  #   type = NeumannBC
  #   variable = xi
  #   value = -1.225938328737e-13
  #   boundary = 'left'
  # [../]
  # [./xv_bc_left]
  #   type = NeumannBC
  #   variable = xv
  #   value = -2.3552830417344e-13
  #   boundary = 'left'
  # [../]
  # [./xi_bc_right]
  #   type = NeumannBC
  #   variable = xi
  #   value = 1.2259383290487e-12
  #   boundary = 'right'
  # [../]
  # [./xv_bc_right]
  #   type = NeumannBC
  #   variable = xv
  #   value = 2.3552830407125e-13
  #   boundary = 'right'
  # [../]
  [./xi_bc]
    type = DirichletBC
...
[Outputs]
  # exodus = true
  file_base = Nickel_1D_uniform+boundary_sink_1e18_773K_1e-3_5%
  [./exodus]
    type = Exodus
