...
[Functions]
  [./dist_source]
    type = ParsedFunction
    value = 'k0:=9.037e-18;mu:=2500;sigma:=500;k0*exp(-((x-mu)^2)/(2*sigma^2))/(1.6e-3*sigma*(2*acos(-1))^0.5)'
  [../]
[]
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#--------------------------------------------------Kernels-----------------------------------------------
...
[BCs]
  ...
  [./xi_bc_left]
    type = NeumannBC
    variable = xi
    value = -8.5777990226031e-16
    boundary = 'left'
  [../]
  [./xv_bc_left]
    type = NeumannBC
    variable = xv
    value = -9.6999589128241e-16
    boundary = 'left'
  [../]
  [./xi_bc_right]
    type = NeumannBC
    variable = xi
    value = 8.5777990232394e-16
    boundary = 'right'
  [../]
  [./xv_bc_right]
    type = NeumannBC
    variable = xv
    value = 9.6999589111566e-16
    boundary = 'right'
  [../]
[]
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
[Outputs]
  # exodus = true
  file_base = Nickel_1D_uniform+boundary_sink_1e18_773K_1e-6_5%
  [./exodus]
    type = Exodus
