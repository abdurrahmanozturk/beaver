...
[BCs]
  ...
  [./xi_bc_left]
    type = NeumannBC
    variable = xi
    value = -4.1494176030388e-14
    boundary = 'left'
  [../]
  [./xv_bc_left]
    type = NeumannBC
    variable = xv
    value = -9.0630237469035e-14
    boundary = 'left'
  [../]
  [./xi_bc_right]
    type = NeumannBC
    variable = xi
    value = 1.2502028815085e-18
    boundary = 'right'
  [../]
  [./xv_bc_right]
    type = NeumannBC
    variable = xv
    value = 2.6084182067295e-14
    boundary = 'right'
  [../]
[]
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
[Outputs]
  # exodus = true
  file_base = Nickel_1D_uniform+boundary_sink_1e18_773K_distributed_source_1e-3_5%
  [./exodus]
    type = Exodus
