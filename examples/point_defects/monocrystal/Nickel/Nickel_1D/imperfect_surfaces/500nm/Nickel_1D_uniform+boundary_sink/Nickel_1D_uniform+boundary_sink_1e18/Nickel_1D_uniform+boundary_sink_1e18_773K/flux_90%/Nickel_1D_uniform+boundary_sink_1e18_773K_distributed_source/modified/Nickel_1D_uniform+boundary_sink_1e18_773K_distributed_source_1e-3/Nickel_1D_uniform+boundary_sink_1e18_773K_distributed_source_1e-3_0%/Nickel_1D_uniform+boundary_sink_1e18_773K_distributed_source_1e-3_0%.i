...
[Functions]
  [./dist_source]
    type = ParsedFunction
    value = 'k0:=9.037e-15;mu:=2500;sigma:=500;if(x>mu,k0*exp(-((x-mu+sigma)^2)/(2*sigma^2))/(0.4*(2*acos(-1))^0.5),k0*exp(-((x-mu+sigma)^2)/(2*sigma^2))/(0.4*(2*acos(-1))^0.5)+0.25*k0*(1-pow((x/mu),2)))'
  [../]
[]
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#--------------------------------------------------Kernels-----------------------------------------------
...
[BCs]
  ...
  [./xi_bc_left]
    type = NeumannBC
    variable = xi
    value = -5.08645243144098e-13
    boundary = 'left'
  [../]
  [./xv_bc_left]
    type = NeumannBC
    variable = xv
    value = -5.08646657403378e-13
    boundary = 'left'
  [../]
  [./xi_bc_right]
    type = NeumannBC
    variable = xi
    value = 1.0508010537737699e-14
    boundary = 'right'
  [../]
  [./xv_bc_right]
    type = NeumannBC
    variable = xv
    value = 1.05066133998867e-14
    boundary = 'right'
  [../]
[]
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
[Outputs]
  # exodus = true
  file_base = Nickel_1D_uniform+boundary_sink_1e18_773K_distributed_source_1e-3_0%
  [./exodus]
    type = Exodus
