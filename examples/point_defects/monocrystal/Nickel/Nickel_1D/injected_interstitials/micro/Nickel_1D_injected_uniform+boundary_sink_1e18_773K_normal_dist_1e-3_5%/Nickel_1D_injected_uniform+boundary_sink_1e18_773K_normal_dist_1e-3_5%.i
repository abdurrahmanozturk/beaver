...
[Functions]
  [./dist_source]
    type = ParsedFunction
    value = 'K0:=9.037e-15;mu:=25000;sigma:=2500;K0*exp(-((x-mu)^2)/(2*sigma^2))/(1.6e-3*sigma*(2*acos(-1))^0.5)'   #A=100 for 150nm 5e-3 for 250nm
  [../]
  [./injected_interstitials_source]
    type = ParsedFunction
    value = 'K0:=9.037e-15;mu:=30000;sigma:=2500;1.5*K0*exp(-((x-mu)^2)/(2*sigma^2))/(1.6e-3*sigma*(2*acos(-1))^0.5)'   #A=100 for 150nm 5e-3 for 250nm
  [../]
[]
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#--------------------------------------------------Kernels-----------------------------------------------
...
[Materials]
  ...
  [./injected_interstitials_i]
    ...
    prop_values = injected_interstitials_source
  [../]
  [./distributed_source_i]
    type = GenericFunctionMaterial
    prop_names = source_i
    prop_values = dist_source
  [../]
  [./distributed_source_v]
    type = GenericFunctionMaterial
    prop_names = source_v
    prop_values = dist_source
  [../]
...
[Outputs]
  # exodus = true
  file_base = Nickel_1D_injected_uniform+boundary_sink_1e18_773K_normal_dist_1e-3_5%
  [./exodus]
    type = Exodus
