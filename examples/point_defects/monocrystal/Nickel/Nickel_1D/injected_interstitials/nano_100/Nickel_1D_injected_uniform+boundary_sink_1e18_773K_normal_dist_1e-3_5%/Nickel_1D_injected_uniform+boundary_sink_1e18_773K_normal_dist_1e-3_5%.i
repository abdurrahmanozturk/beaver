...
[Functions]
  [./dist_source]
    type = ParsedFunction
    value = 'K0:=9.037e-15;mu:=500;sigma:=100;K0*exp(-((x-mu)^2)/(2*sigma^2))/(1.6e-3*sigma*(2*acos(-1))^0.5)'   #A=100 for 150nm 5e-3 for 250nm
  [../]
  [./injected_interstitials_source]
    type = ParsedFunction
    value = 'K0:=9.037e-15;mu:=500;sigma:=100;1.5*K0*exp(-((x-mu)^2)/(2*sigma^2))/(1.6e-3*sigma*(2*acos(-1))^0.5)'   #A=100 for 150nm 5e-3 for 250nm
  [../]
[]
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#--------------------------------------------------Kernels-----------------------------------------------
