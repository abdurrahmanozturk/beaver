...
[Functions]
  [./dist_source_FP]
    type = ParsedFunction
    value = 'K0:=9.037e-13;fsurvive:=0.25;ficluster:=0.30;mu:=1000;sigma:=200;if(x>mu,fsurvive*(1-ficluster)*K0*exp(-((x-mu+sigma)^2)/(2*sigma^2))/(0.4*(2*acos(-1))^0.5),fsurvive*(1-ficluster)*K0*exp(-((x-mu+sigma)^2)/(2*sigma^2))/(0.4*(2*acos(-1))^0.5)+0.25*fsurvive*(1-ficluster)*K0*(1-pow((x/mu),2)))'
    # value = 'K0:=9.037e-13;mu:=1000;sigma:=200;K0*exp(-((x-mu)^2)/(2*sigma^2))/(0.4*(2*acos(-1))^0.5)'
  [../]
  [./dist_source_II]
    type = ParsedFunction
    value = 'f_ii:=1.6e-4;K0:=9.037e-13;fsurvive:=0.25;mu:=1150;sigma:=200;f_ii*fsurvive*K0*exp(-((x-mu)^2)/(2*sigma^2))/(0.4*(2*acos(-1))^0.5)'
  [../]
[]
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#--------------------------------------------------Kernels-----------------------------------------------
