...
#         3- Equilibrium concentrations are at boundaries
#         4- Uniformly distributed constant defect source (Neutron Case)
...
[ICs]
  ...
  [./xi]
    type = RandomIC
    min = 1e-28        # Nickel equilibrium interstitial concentration
    max = 2e-28
    variable = xi
  [../]
  # [./xs]
...
[Executioner]
  ...
  nl_abs_tol = 1e-16 # Absolute tolerance for nonlienar solves
  nl_rel_tol = 1e-6 # Relative tolerance for nonlienar solves
  scheme = bdf2   #try crank-nicholson
  automatic_scaling = true
  start_time = 0
  end_time = 1e20 #executioner
...
#----------------------------------------------Outputs----------------------------------------------------
[Outputs]
  file_base = Nickel_1D_1e18_773K_neutron_1e-3_0%
  csv = true
  interval = 10 #Outputs
