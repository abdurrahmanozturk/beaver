# This is simulate site-saturation phase transformation kinetics
# in systems with very short nucleation stage
# the overall transformation rate is then controlled only by growth  
...
[ICs]
  [./eta] #Creates circles with smooth interfaces at random locations
...
[Outputs]
  file_base = site_saturation_model_A
  exodus = true
  csv = true
  interval = 1
[]
