#ifndef FINDVIEWFACTORS_H
#define FINDVIEWFACTORS_H
...
class FindViewFactors;

template <>
InputParameters validParams<FindViewFactors>();

class FindViewFactors : public SideUserObject
{
public:
  FindViewFactors(const InputParameters & parameters);
