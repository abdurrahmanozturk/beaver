...
registerMooseObject("beaverApp", MonteCarloViewFactor);

template <>
InputParameters
validParams<MonteCarloViewFactor>()
{
  InputParameters params = validParams<MonteCarloViewFactorBase>();
...
MonteCarloViewFactor::MonteCarloViewFactor(const InputParameters & parameters)
  : MonteCarloViewFactorBase(parameters),
...
void
MonteCarloViewFactor::initialize()
{
  std::cout << "------------------------" << std::endl;
...
//
// void
// MonteCarloViewFactor::threadJoin(const UserObject & y)
// {
//   const MonteCarloViewFactor & vf = dynamic_cast<const MonteCarloViewFactor &>(y);
...
Real MonteCarloViewFactor::getViewFactor(BoundaryID master_bnd, unsigned int master_elem, BoundaryID slave_bnd, unsigned int slave_elem) const
{
