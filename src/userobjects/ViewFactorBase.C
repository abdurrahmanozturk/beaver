...
const bool
ViewFactorBase::isSidetoSide(const std::map<unsigned int, std::vector<Real>> & master,
...
const bool
ViewFactorBase::isVisible(const std::map<unsigned int, std::vector<Real>> & master,
                      const std::map<unsigned int, std::vector<Real>> & slave) const
{
...
const Real
ViewFactorBase::doMonteCarlo(std::map<unsigned int, std::vector<Real>> master_elem_map,
                             std::map<unsigned int, std::vector<Real>> slave_elem_map,
                             unsigned int _sourceNumber, unsigned int _samplingNumber)
{
